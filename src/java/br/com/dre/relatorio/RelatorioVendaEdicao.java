 ...
 * @author thiag
 */
public class RelatorioVendaEdicao {
    ...
    */
    public void getRelatorio(List<VendaEdicao> listaVendaEdicao){
        ...
        try {
            ...
            */
            JasperPrint print = JasperFillManager.fillReport(report, params, new JRBeanCollectionDataSource(listaVendaEdicao));
            ...
            Logger.getLogger(RelatorioVendaEdicao.class.getName()).log(Level.SEVERE, null, ex);
